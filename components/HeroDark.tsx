  ...
  return (
    <section className="text-center py-20 bg-transparent">
      <div className="flex flex-col items-center mb-8">
        <h1 className="text-5xl sm:text-6xl font-bold mb-4 bg-gradient-text-dark">
          Hi{" "}
          {!handImageError ? (
            <Image
        ...
        <p className="text-2xl text-slate-400 max-w-2xl mx-auto mb-6">
        ...
        <div className="relative group mb-8 transform transition-all duration-300 hover:scale-[1.02] hover:shadow-xl">
          {!codingImageError ? (
            ...
            <div className="w-[400px] h-[225px] bg-slate-800 rounded-lg shadow-2xl flex items-center justify-center">
      ...
      <div className="text-lg text-slate-400 max-w-2xl mx-auto space-y-4">

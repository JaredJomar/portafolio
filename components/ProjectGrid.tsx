...
export default function ProjectGrid() {
  ...
  return (
    <section id="projects" className="py-16 bg-white/95 dark:bg-[#0A121F]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-bold mb-4 dark:bg-gradient-text-dark bg-gradient-text-light">
            Featured Projects
          </h2>
        ...
        <div className="mb-10">
          <p className="text-center mb-4 text-sm font-medium text-gray-800 dark:text-white">Filter by technology</p>
          ...
          <div className="flex flex-wrap justify-center gap-2 mb-4">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    activeCategory === category.id
                      ? (
                        category.id === "languages" ? "bg-blue-100 text-blue-700 dark:bg-blue-900/40 dark:text-blue-300" :
                          category.id === "frameworks" ? "bg-indigo-100 text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-300" :
                            category.id === "tools" ? "bg-green-100 text-green-700 dark:bg-green-900/40 dark:text-green-300" :
            ...
            {activeFilter && (
              <button
                ...
                className="px-3 py-1 rounded-full text-sm bg-gray-100 text-gray-600 hover:bg-gray-200 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700 flex items-center gap-1"
              >
        ...
        {activeFilter && (
          <div className="text-center mb-6">
            <p className="text-gray-600 dark:text-slate-400">
              ...
              using <span className="font-medium text-blue-600 dark:text-blue-400">{activeFilter}</span>
            </p>
          </div>
        )}
        ...
        {activeFilter && filteredProjects.length === 0 && (
          <div className="text-center py-10">
            <p className="text-xl text-gray-600 dark:text-slate-400">No projects match the selected filter.</p>
            <button
              onClick={resetFilters}
              className="mt-4 px-4 py-1 rounded-full text-sm bg-gray-100 text-gray-600 hover:bg-gray-200 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700 flex items-center gap-1 mx-auto"
            >

...
export default function Hero() {
  ...
  return (
    <section className="text-center py-20 bg-white dark:bg-transparent">
      <div className="flex flex-col items-center mb-8">
        <h1 className="text-5xl sm:text-6xl font-bold mb-4 bg-gradient-text-light dark:bg-gradient-text-dark">
          Hi{" "}
          {!handImageError ? (
            <Image
        ...
        <p className="text-2xl text-gray-600 dark:text-slate-400 max-w-2xl mx-auto mb-6">
        ...
        <div className="relative group mb-8">
          {!codingImageError ? (
            ...
            <div className="w-[400px] h-[225px] bg-blue-100 dark:bg-slate-800 rounded-lg shadow-2xl flex items-center justify-center">
      ...
      <div className="text-lg text-gray-600 dark:text-slate-400 max-w-2xl mx-auto space-y-4">

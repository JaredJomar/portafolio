...
export default function ProjectGridDark() {
    ...
    return (
        <section id="projects" className="py-16 bg-[#0A121F]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    <h2 className="text-3xl sm:text-4xl font-bold mb-4 bg-gradient-text-dark">
                        Featured Projects
                    </h2>
                ...
                <div className="mb-10">
                    <p className="text-center mb-4 text-sm font-medium text-white">Filter by technology</p>
                    ...
                    <div className="flex flex-wrap justify-center gap-2 mb-4">
                                ...
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        activeCategory === category.id
                                            ? (
                                                category.id === "languages" ? "bg-blue-900/40 text-blue-300" :
                                                    category.id === "frameworks" ? "bg-indigo-900/40 text-indigo-300" :
                                                        category.id === "tools" ? "bg-green-900/40 text-green-300" :
                        ...
                        {activeFilter && (
                            <button
                                ...
                                className="px-3 py-1 rounded-full text-sm bg-slate-800 text-slate-300 hover:bg-slate-700 flex items-center gap-1"
                            >
                ...
                {activeFilter && (
                    <div className="text-center mb-6">
                        <p className="text-slate-400">
                            ...
                            using <span className="font-medium text-blue-400">{activeFilter}</span>
                        </p>
                    </div>
                )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {(activeFilter ? filteredProjects : projects)
                        ...
                        .map((project) => (
                            ...
                            >
                                <ProjectCardDark project={project} />
                            </motion.div>
                        ))}
                </div>
                ...
                {activeFilter && filteredProjects.length === 0 && (
                    <div className="text-center py-10">
                        <p className="text-xl text-slate-400">No projects match the selected filter.</p>
                        <button
                            onClick={resetFilters}
                            className="mt-4 px-4 py-1 rounded-full text-sm bg-slate-800 text-slate-300 hover:bg-slate-700 flex items-center gap-1 mx-auto"
                        >
